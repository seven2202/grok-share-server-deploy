...
--
-- Table structure for table `grok_conversations`
--
...
--
-- Dumping data for table `grok_conversations`
--

LOCK TABLES `grok_conversations` WRITE;
/*!40000 ALTER TABLE `grok_conversations` DISABLE KEYS */;
/*!40000 ALTER TABLE `grok_conversations` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `grok_session`
--

LOCK TABLES `grok_session` WRITE;
/*!40000 ALTER TABLE `grok_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `grok_session` ENABLE KEYS */;
UNLOCK TABLES;
